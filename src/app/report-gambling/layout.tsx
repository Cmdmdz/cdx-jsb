...
export const metadata: Metadata = {
    title: 'แจ้งเบาะแสเว็บพนัน',
    description: 'แจ้งเบาะแสเว็บพนัน / ร้องเรียนพนัน'
}

const ReportGamblingLayout = ({ children }: PropsWithChildren) => {
    return (
        <div>
            <FormHeader>แจ้งเบาะแส การพนันออนไลน์</FormHeader>
            {children}
            <div
...
export default ReportGamblingLayout
